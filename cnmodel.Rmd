...
<!-- \subsubsection{\vcmax\ and leaf respiration} -->
<!-- \label{sec:vcmax} -->
...
<!-- \subsubsection{Metabolic leaf N} -->
...
<!-- \subsubsection{Structural leaf N} -->
...
<!-- \subsubsection{Functions for the allocation algorithm} -->
...
<!-- $$ -->
<!-- \pdv{N_{\mathrm{up}}}{C_{\mathrm{ex}}} =  \psi_N \; N_{\mathrm{av}} -->
<!-- $$ -->
...
<!-- $$ -->
<!--   \psi_{\mathrm{fix}} = \pdv{N_{\mathrm{fix}}}{C_{\mathrm{ex}}^{\mathrm{fix}}} =  \psi_{\mathrm{fix}}^{\mathrm{max}}\cdot 1.25 \cdot\exp(a_{\mathrm{fix}} + b_{\mathrm{fix}}\;T_{\mathrm{soil}}\;(1 - 0.5\;\frac{T_{\mathrm{soil}}}{T_{\mathrm{fix}}^{\mathrm{opt}}} )) -->
<!-- $$ -->
...
<!-- $$ -->
<!-- \psi^{\ast} = \pdv{N_{\mathrm{up}}}{C_{\mathrm{ex}}} \Bigr|_{C_{\mathrm{ex}}=C_{\mathrm{ex}}^{\ast}} = \psi_{\mathrm{fix}} -->
<!-- $$ -->
...
<!-- %\subsubsection{New formulation of Nitrogen uptake} -->
...
<!-- \subsubsection{Net N mineralisation} -->
...
<!-- \subsubsection{Ammonium volatilisation} -->
